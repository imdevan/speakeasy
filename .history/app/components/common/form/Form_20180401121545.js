...
class Form extends  React.Component {
  ...
  render() {
    const { submitAction = values => console.log(values), sections, submitLabel, submitButtonClassName, showSubmitButton, className, pristine, submitting} = this.props;
    console.log('initialValues', this.props.initialValues);

    return (
      <form handleSubmit={submitAction} className={className}>
