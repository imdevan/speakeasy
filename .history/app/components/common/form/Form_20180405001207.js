...
class Form extends  React.Component {
  ...
  render() {
    const { sections, submitLabel, submitButtonClassName, showSubmitButton, className, pristine, submitting} = this.props;
...
export default connect((state,ownProps) => ({
  onSubmit: ownProps.onSubmit ? ownProps.onSubmit : (e) => {console.log('does this work?')},
